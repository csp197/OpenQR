...
def test_get_cache_path_with_colors(generator):
    ...
    cache_path2 = generator._get_cache_path(
        url, fill_color="green", back_color="yellow"
    )
...
@pytest.mark.skip(
    reason="Clipboard tests require QApplication which crashes in test environment"
)
